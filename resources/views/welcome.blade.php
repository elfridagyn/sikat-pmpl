...
<body class="min-h-screen bg-cover bg-center bg-no-repeat antialiased flex flex-col justify-between"
    ...
    <div id="loadingOverlay"
        class="hidden fixed inset-0 bg-gray-950/40 backdrop-blur-md flex justify-center items-center z-[9999]">

        <div class="bg-white p-6 rounded-[24px] shadow-2xl flex flex-col items-center space-y-3 border border-gray-100">
            <svg class="animate-spin h-8 w-8 text-[#4e7281]"
            ...
            <span class="text-xs font-semibold text-gray-700 tracking-tight">
                Loading...
            </span>
        </div>
    </div>
            ...
            <div class="bg-white/30 backdrop-blur-xl border border-white/20 rounded-[2rem] p-8 shadow-2xl space-y-4 hover:bg-white/40 transition">
                <div class="w-12 h-12 bg-[#4e7281]/10 rounded-2xl flex items-center justify-center text-[#4e7281]">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h.01M16 20h2M4 12h2m0 0h2v-2m0 0h2"></path>
                    </svg>
                </div>
